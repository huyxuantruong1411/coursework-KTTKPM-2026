...
class _EditAccountScreenState extends State<EditAccountScreen> {
  ...
  Future<void> _save() async {
    ...
    if (newUsername == null && newEmail == null && newPass == null) {
        ...
        actions: [
          if (_isLoading)
            ...
            TextButton(
              ...
              child: const Text(
                'Lưu',
                style: TextStyle(color: _kOrange, fontWeight: FontWeight.bold, fontSize: 16),
              ),
            ),
        ],
      ),
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildField(
              ...
              validator: (v) {
                if (v == null || v.trim().isEmpty) return 'Tên đăng nhập không được để trống';
            ...
            SwitchListTile(
              ...
              title: const Text('Tôi muốn đổi mật khẩu', style: TextStyle(color: Colors.white, fontSize: 14)),
            ...
            if (_changePassword) ...[
              ...
              _buildPasswordField(
                ...
                validator: (v) {
                  if (_changePassword && (v == null || v.isEmpty)) return 'Nhập mật khẩu hiện tại';
                  return null;
                },
              ),
              const SizedBox(height: 12),
              ...
              _buildPasswordField(
                ...
                validator: (v) {
                  if (_changePassword && v != _newPassCtrl.text) return 'Mật khẩu không khớp';
                  return null;
                },
              ),
            ],
  ...
  Widget _sectionHeader(String text) {
    return Text(text, style: const TextStyle(color: _kOrange, fontSize: 13, fontWeight: FontWeight.bold, letterSpacing: 0.5));
  }
